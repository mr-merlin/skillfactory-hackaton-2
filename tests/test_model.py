...
def test_high_conversion_scenario():
    ...
    print("📋 Ожидаемое поведение: Пользователь с высоким вовлечением, iOS устройством, в пиковые часы должен показать высокую вероятность конверсии")
...
def test_low_conversion_scenario():
    ...
    print("📋 Ожидаемое поведение: Пользователь с низким вовлечением, десктопом, в неактивные часы должен показать низкую вероятность конверсии")
...
def test_medium_conversion_scenario():
    ...
    print("📋 Ожидаемое поведение: Пользователь со средними показателями должен показать среднюю вероятность конверсии")
...
def main():
    ...
    if not test_api_connection():
        print("❌ API сервер недоступен. Запустите API сервер (опция 2) перед тестированием.")
        return
